...
// function setupConfigServers () {
//
// }
//
// function setupShardServers () {
//
// }
//
// function setupMongos () {
//
// }
...
module.exports = {
    ...
    createShardedClusterDB: async (configHosts, shardsHosts, mongosHosts, username, privateKey, dbUsername, serverData) => {
        try {
            ...
            // call createReplicaSetForSH for config and each shard
            // make a different function for mongos
