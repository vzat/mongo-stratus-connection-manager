...
async function createReplicaSetForSH (hosts, username, privateKey, dbUsername, serverData, keyfile, replicaType) {
    try {
        ...
        logger.log('info', replicaType);
        logger.log('info', serverData);
...
module.exports = {
    createSingleNodeDB: async (host, username, privateKey, dbUsername, serverData) => {
        ...
        try {
            ...
            //     },
            //     type: 'single-node',
            //     platform: privateKey.substring(0, privateKey.indexOf('/'))
            // };
            ...
            const database2 = {
                ...
                type: 'single-node',
                platform: privateKey.substring(0, privateKey.indexOf('/')),
                version: serverData.mongoVersion
            };
